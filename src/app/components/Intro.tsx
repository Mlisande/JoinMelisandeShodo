      ...
      >
        <Grid2 size={{ xs: 8, lg: 5 }}>
          <Typography variant="body1">
            ...
            individus comme les entreprises ont le pouvoir d’agir, à travers
            leurs choix de consommation, d'employeur·euse, en faveur de rapports
            humains plus justes".
          </Typography>
        </Grid2>
        <Grid2 size={{ xs: 8, lg: 5 }}>
          <Typography variant="body1">
            Aujourd'hui, je choisis d'oser vous contacter même si ça fait
            plusieurs semaines que j'ai peur de le faire.
          </Typography>
          <Typography>
